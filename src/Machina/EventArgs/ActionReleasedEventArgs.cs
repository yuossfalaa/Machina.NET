...
/// </summary>
public class ActionReleasedEventArgs : MachinaEventArgs
{
    /// <summary>
    ...
    public ActionReleasedEventArgs(Action last, int pendingReleaseToDevice, Vector pos, Rotation ori, Joints axes, ExternalAxes extax)
    {
