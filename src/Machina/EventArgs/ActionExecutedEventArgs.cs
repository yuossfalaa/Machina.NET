...
/// </summary>
public class ActionExecutedEventArgs : MachinaEventArgs
{
    /// <summary>
    ...
    public ActionExecutedEventArgs(Action last, int pendingExecutionOnDevice, int pendingExecutionTotal, Vector pos, Rotation ori, Joints axes, ExternalAxes extax)
    {
